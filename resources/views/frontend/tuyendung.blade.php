            ...
            <div class="row justify-content-center pt-3 mt-md-3">
                <div class="col-12">
                    ...
                    <p style="text-align:justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                        ...
                        laborum. Ut enim ad minima veniam, quis nostrum exercitationem occaecat cupidatat non proident.
                    </p>
                    <p style="text-align:justify">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                        nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate
                        velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
                        proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <p style="text-align:justify">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                ...
                <div class="tns-carousel">
                    <div class="tns-carousel-inner"
                        ...
                        <article>
                            ...
                            <h3 class="h6 blog-entry-title"><a href="#">We Launched Regular Drone Delivery in
                                    California. Watch Demo Video</a></h3>
                        </article>
                        <article>
                            <a class="blog-entry-thumb mb-3" href="#"><img src="{{ asset('public/img/02.jpg') }}" /></a>
                            <div class="d-flex align-items-center fs-sm mb-2">
